// Minimal ISO 3166-1 alpha-2 country codes mapping to English names
// Note: For brevity, this includes a comprehensive common set. Extend as needed.
